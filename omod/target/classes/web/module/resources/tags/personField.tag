...
<c:if test="${ canAddNewPerson }">
    <div id="${ formFieldId }_addDialog">
        ...
        <openmrs:forEachRecord name="gender">
            <input type="radio" name="${ formFieldId }_add_gender" id="${ formFieldId }_add_gender_${record.key}"
                   value="${record.key}"/>
