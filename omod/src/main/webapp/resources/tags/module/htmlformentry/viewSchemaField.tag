            ...
            <tr>
                ...
                <td>${field.name} -&gt;
                    <a style="color:green;" target="_blank"
                       href="${pageContext.request.contextPath}/dictionary/concept.htm?conceptId=${field.question.conceptId}">
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(field.answers) == 1}">
                                    ...
                                    <a style="color:green;" target="_blank"
                                       href="${pageContext.request.contextPath}/dictionary/concept.htm?conceptId=${field.answers[0].concept.conceptId}">
                    ...
                    <c:otherwise>
                        ...
                        <td>
                            <c:forEach items="${field.answers}" var="ans">
                                ${ans.displayName} -&gt;
                                <a style="color:green;" target="_blank"
                                   href="${pageContext.request.contextPath}/dictionary/concept.htm?conceptId=${ans.concept.conceptId}">
